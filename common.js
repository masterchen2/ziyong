...
const signhost = process.env.signhost || "mzkj666.cn:18848";
...
async function xsign(api, data, uid, sid, wua, v) {
    try {
        const requestData = {
            data: data,
            api: api,
        ...
        const response = await axios.post(`http://${signhost}/api/getXSign`, requestData, {
            headers: {
                'Content-Type': 'application/json',
            }
        });
...
async function req(api, data, uid, sid, wua = false, v = '1.0') {
    try {
        ...
        const sign = await xsign(api, data, uid, sid, wua, v);
        const host = 'https://acs.m.goofish.com';
        const headers = {
            'x-sgext': encodeURIComponent(sign['x-sgext']),
            'x-sign': encodeURIComponent(sign['x-sign']),
            'x-sid': sid,
            'x-uid': uid,
            'x-pv': '6.3',
            'x-features': '1051',
            'x-mini-wua': encodeURIComponent(sign['x-mini-wua']),
        ...
        if (response.data.ret[0] === 'SUCCESS::调用成功') {
            let a = response.data;
            return a;
        } else {
            return a;
...
function _0x581038(f, o, e, b, n, y, a, l) {
    let requestData = {data: f, api: o, pageId: decodeURIComponent(e), uid: y, deviceId: a, utdid: l};
    if (b) {
        requestData.sid = b;
    }
    const aa = {method: "POST", headers: {"content-type": "application/json"}, url: `http://${signhost}/api/getXSign`, body: JSON.stringify(requestData)};
    return new Promise(resolve => {
        const timeout = setTimeout(() => {
            clearTimeout(timeout);
            resolve(null);
        }, 5e3);
        request(aa, async (error, response, body) => {
            clearTimeout(timeout);
            if (!error) {
                try {
...
async function _0x21a086(vasilia, jonattan) {
    let zheneavia = _0x5a5a78(vasilia), yler = zheneavia.get("deviceId"), jayahna = zheneavia.get("utdid"), trishna = zheneavia.get("USERID"), kastriot = zheneavia.get("token");
    if (!kastriot) {
        console.log("未获取到刷新 token，自动续期 ck 失败");
        return;
    }
    let altheia = zheneavia.get("umt"), noriyah = '{"ext":"{\\"apiReferer\\":\\"{\\\\\\"errorCode\\\\\\":\\\\\\"7\\\\\\",\\\\\\"eventName\\\\\\":\\\\\\"autologinFailed\\\\\\"}{\\\\\\"errorCode\\\\\\":\\\\\\"7\\\\\\",\\\\\\"eventName\\\\\\":\\\\\\"autologinFailed\\\\\\"}{\\\\\\"errorCode\\\\\\":\\\\\\"7\\\\\\",\\\\\\"eventName\\\\\\":\\\\\\"autologinFailed\\\\\\"}{\\\\\\"errorCode\\\\\\":\\\\\\"7\\\\\\",\\\\\\"eventName\\\\\\":\\\\\\"autologinFailed\\\\\\"}{\\\\\\"errorCode\\\\\\":\\\\\\"7\\\\\\",\\\\\\"eventName\\\\\\":\\\\\\"autologinFailed\\\\\\"}{\\\\\\"errorCode\\\\\\":\\\\\\"7\\\\\\",\\\\\\"eventName\\\\\\":\\\\\\"autologinFailed\\\\\\"}{\\\\\\"errorCode\\\\\\
\"\\"}","riskControlInfo":"{\\"appStore\\":\\"1608030065155@eleme_android_11.1.38\\",\\"deviceBrand\\":\\"Google\\",\\"deviceModel\\":\\"AOSP on blueline\\",\\"deviceName\\":\\"AOSP on blueline\\",\\"osName\\":\\"android\\",\\"osVersion\\":\\"10\\",\\"screenSize\\":\\"0x0\\",\\"t\\":\\"' + (new Date).getTime() + '\\",\\"umidToken\\":\\"' + altheia + '\\",\\"wua\\":\\"ISdF_FRG6WfAC3hq3tKFPCpwtmaqmW\\\\/HCzXLk3\\/sCpKM8WVg+0+3t4dsh82tlLh2i1V4g5MRJkbZn4c1EoC0ug92R7WUG0Gqs9+0DsyceK03b7Ckh7UozNrXo4\\"}"}', yvenson = "com.taobao.mtop.mloginunitservice.autologin", ahnyah = "https%3A%2F%2Fr.ele.me%2Fmagic-cube%2F%3FnavType%3D3%26spm%3Da13.b_activity_kb_m71293.0.0%23%2Fgame", neff = zheneavia.get("cookie2"), c = zheneavia.get("unb"), skyle = await _0x581038(noriyah, yvenson, ahnyah, neff, jonattan, c, yler, jayahna);
    if (!skyle) {
        return skyle;
    }
    let kennyth = encodeURIComponent(skyle["x-sgext"]), phelicia = encodeURIComponent(skyle["x-sign"]);
    altheia = encodeURIComponent(skyle["x-umt"]);
    let colbi = encodeURIComponent(skyle["x-mini-wua"]), leeannah = skyle["x-t"], keniesha = encodeURIComponent(skyle.wua), seslie = {"x-sgext": kennyth, "x-sign": phelicia, "x-devid": yler, "x-pv": "6.3", "x-features": "1051", "x-mini-wua": colbi, "content-type": "application/x-www-form-urlencoded;charset=UTF-8", "x-t": leeannah, "x-bx-version": "6.5.90", "f-refer": "mtop", "x-extdata": "openappkey%3DDEFAULT_AUTH", "x-ttid": "1551089129819%40eleme_android_10.14.3", "x-app-ver": "10.14.3", "x-umt": altheia, "x-utdid": encodeURIComponent(jayahna), "x-appkey": "24895413", "x-page-url": ahnyah, Host: "guide-acs.m.taobao.com", "user-agent": "MTOPSDK%2F3.1.1.7+%28Android%3B13%3BGoogle%3BPixel+4+XL%29", "x-sid": neff, "x-uid": c, Cookie: vasilia, asac: "2A22C0239QW1FOL3UUQY7U"}, terrod = "https://guide-acs.m.taobao.com/gw/com.taobao.mtop.mloginunitservice.autologin/1.0/?data=" + encodeURIComponent(noriyah) + "&type=originaljson&wua=" + keniesha;
    const saania = {method: "POST", url: terrod, headers: seslie, body: noriyah};
    return _0x13509e(christon => {
        request(saania, async (ninah, corvus, ilea) => {
            if (!ninah && corvus.statusCode === 200) {
                try {
                    const deian = JSON.parse(ilea);
                    christon(deian);
                } catch (einin) {
                    console.log(einin);
                    christon(null);
